...
public class TypeExtends extends TypeAdapter {
	...
	public String getGenericName(boolean asArgType, Set<String> packages, Set<String> classes) {
		if (!asArgType) {
			if (Types.OBJECT.equals(type)) {
				...
				return Strings.isNullOrEmpty(genericName) ? HOOK
						: HOOK + SPACE + EXTENDS + SPACE + genericName;
			}
		} else {
	...
	public boolean equals(Object o) {
		if (o == this) {
			...
			return Objects.equal(((TypeExtends) o).varName, varName) && ((TypeExtends) o).type.equals(type);
		} else {
			return false;
		}
	}
